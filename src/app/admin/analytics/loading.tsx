        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <Card key={i}>
            <CardHeader>
              ...
              <div className="mt-1 h-7 w-16 animate-shimmer rounded bg-muted" />
            </CardHeader>
            <CardContent>
              <div className="h-3 w-28 animate-shimmer rounded bg-muted" />
            </CardContent>
          </Card>
        ))}
      </div>
          ...
          <CardContent className="space-y-4">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="space-y-1.5">
                <div className="h-4 w-40 animate-shimmer rounded bg-muted" />
                <div className="h-2 w-full animate-shimmer rounded-full bg-muted" />
              </div>
            ))}
          </CardContent>
        </Card>
