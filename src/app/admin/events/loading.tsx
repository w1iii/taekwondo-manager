  ...
  const eventCard = (key: number) => (
    <Card key={key}>
      <CardContent className="flex flex-col gap-4 py-4 sm:flex-row sm:items-start">
        <div className="h-28 w-full shrink-0 animate-shimmer rounded-lg bg-muted sm:h-24 sm:w-36" />
        ...
        <div className="h-9 w-36 shrink-0 animate-shimmer rounded bg-muted" />
      </CardContent>
    </Card>
  );
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <div className="h-8 w-28 animate-shimmer rounded bg-muted" />
