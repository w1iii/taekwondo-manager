    ...
    <div className="mx-auto w-full max-w-2xl space-y-6">
      ...
      <Card>
        <CardContent className="space-y-2">
          <div className="h-48 animate-shimmer rounded-lg bg-muted" />
          <div className="h-4 w-2/3 animate-shimmer rounded bg-muted" />
          <div className="h-4 w-1/2 animate-shimmer rounded bg-muted" />
          <div className="h-4 w-2/3 animate-shimmer rounded bg-muted" />
          <div className="h-6 w-32 animate-shimmer rounded-full bg-muted" />
        </CardContent>
      </Card>
        ...
        <Card>
          <CardContent className="space-y-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="h-10 w-full animate-shimmer rounded bg-muted" />
            ))}
          </CardContent>
        </Card>
      </section>
